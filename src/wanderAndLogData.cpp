...
int main(int argc, char **argv)
{
    ...
    /* Estas son las funciones que realizan las acciones para que el robot evada los obstaculos*/
    ...
    while(robot.isRunning()) {
        printf("sonar num: %d\n",robot.getNumSonar());           //Se imprime la cantidad de sonares del robot
        printf("sonar range 1: %d\n",robot.getSonarRange(1));    //Imprime el rango del sonar 1
        printf("sonar range 2: %d\n",robot.getSonarRange(2));    //Imprime el rango del sonar 2
